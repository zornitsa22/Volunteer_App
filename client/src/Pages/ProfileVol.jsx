...
const ProfileVol = () => {
  ...
  return (
    <div className="bg-white shadow-md rounded-lg p-4 mx-auto w-96 mt-8 sm:w-full sm:max-w-md">
      ...
      {volunteer && (
        <div>
          <p className="text-4xl font-semibold text-center text-[#2A4434] mb-4">{volunteer.volunteer.volunteername}</p>
          ...
          <div className="mt-4">
            <p className="">
              <MdEmail className="inline text-gray-500 mr-2" /> <span className='font-semibold'> Email:</span>
              <span className=" text-gray-700 ml-2">{volunteer.volunteer.email}</span>
            </p>
            <p className=" mt-4 ">
              <FaPhone className="inline text-gray-500 mr-2" /> <span className='font-semibold'> Phone:</span>
