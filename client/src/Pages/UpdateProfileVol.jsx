...
const UpdateProfileVol = () => {
    ...
    const updateVolunteer = async () => {
        try {
            ...
            const response = await axios.put(`/api/volunteers/profile/update`, formData);
            setVolunteer(response.data);
...
const handleChange = (e) => {
    ...
    return (
      ...
      >
      <h2 className="text-[#2A4434] font-bold py-12 text-4xl text-center">Please Update Your profile </h2>
          <form className="bg-white shadow-md rounded-lg px-8 pt-6 pb-8 mb-4 w-full max-w-[600px]" onSubmit={handleSubmit}>
        
            <label htmlFor="volunteername" className="block text-gray-600 font-bold mb-2">Name</label>
            <input type="text"
            ...
            <label htmlFor="skills" className="block text-gray-600 font-bold mb-2 mt-4">Skills</label>
            <input type="text"
            className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
            name="skills"
            ...
            <label htmlFor="description" className="block text-gray-600 font-bold mb-2 mt-4">About Me</label>
            <input type="text"
            className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
            name="description" 
            ...
            <label htmlFor="email" className="block text-gray-600 font-bold mb-2 mt-4">Email</label>
            <input type="email"
            className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
            name="email" 
            ...
            <label htmlFor="contactInfo" className="block text-gray-600 font-bold mb-2 mt-4">Phone</label>
            <input type="text"
            className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
            name="contactInfo" 
            ...
            <label htmlFor="" className="block text-gray-600 font-bold mb-2 mt-4">Image</label>
            <input type="file"
            name='image' 
            accept="image/*"
            onChange={handleChange} />
