...
return (
    <div >
        ...
        <h1 className='px-4 text-4xl Sm:text-2xl text-center font-bold'> Welcome to the Volunteer & Organization Portal</h1>      
        <h2 className='font-bold text-2xl text-center py-2 mb-8'>Register & Log in to Get Involved!</h2>
                    ...
                    <div className='opacity-0 group-hover:opacity-100 '>
                        <div className='pt-8 text-center'>
                            <a href="/register/volunteer">
                                <button className='text-center rounded-lg px-4 py-3 m-2 bg-blue-500  hover:bg-pink-600 text-white font-bold text-lg'>
                                    Register 
                                </button>
                            </a>
                            <a href="/login/volunteer">
                                <button className='text-center rounded-lg px-4 py-3 m-2 bg-green-300 text-white  hover:bg-pink-600 marker:font-bold text-lg'>
                                    Login
                                </button>
                            </a>
                        </div>
                ...
                {/**Hover effects */}
                        ...
                        <div className='pt-8 text-center'>
                            <a href="/register/organization">
                                <button className='text-center rounded-lg px-4 py-3 m-2 bg-white  hover:bg-pink-600 text-gray-700 font-bold text-lg'>
                                    Register 
                                </button>
                            </a>
                            <a href="/login/organization">
                                <button className='text-center rounded-lg px-4 py-3 m-2 bg-white  hover:bg-pink-600 selection: text-gray-700 font-bold text-lg'>
                                    Login
                                </button>
                            </a>
                        </div>
