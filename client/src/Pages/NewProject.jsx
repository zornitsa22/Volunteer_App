...
const NewProject = () => {
  ...
  return (
    <div className="bg-[#d3e7cb] mx-auto px-4 py-12">
      <div
      ...
      >
        <div className="container mx-auto text-center">
          <h2 className="text-4xl font-bold mb-4 text-white">
            Welcome{" "}
            <span className="text-white">{organization.organizationName}</span>
          </h2>
      ...
      <div className="max-w-xl mx-auto mt-8 bg-white p-6 rounded-lg shadow-lg">
        <h2 className="text-2xl font-semibold mb-6 text-[#2A4434]">
          Add a New Project
        </h2>
        <form onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className="bg-[#A9BE93] hover:bg-[#2A4434] text-white py-2 px-4 rounded-md focus:outline-none focus:ring-2 focus:ring-green-300"
          >
            Submit
          </button>
        </form>
